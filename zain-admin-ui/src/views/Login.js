            ...
            >
              <div className="mb-1">
                ...
                <span 
                  className="error" 
                >
                  {serverError && serverError.email ? serverError.email[0]: null}
                </span>
              </div>
              <div className="mb-1">
                ...
                <span 
                  className="error" 
                >
                  {serverError && serverError.password ? serverError.password[0]: null}
                </span>
              </div>
              ...
              <span 
                  ...
                  color="warning"
                >
                  {serverError && serverError.non_field_errors ? serverError.non_field_errors[0]: null}
              </span>
