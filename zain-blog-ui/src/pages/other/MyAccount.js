...
const MyAccount = () => {
  ...
  console.log("pre check token", access_token);
                            ...
                            <div className="row">
                              <div className="col-lg-6 col-md-6">
                                <div className="billing-info">
                                  ...
                                  <input type="text" value={user_info ? user_info.name: " "} />
                                </div>
                              </div>
                              <div className="col-lg-6 col-md-6">
                                <div className="billing-info">
                              ...
                              <div className="col-lg-12 col-md-12">
                                <div className="billing-info">
                                  <label>Email</label>
                                  <input type="email" value={user_info ? user_info.email: " "} />
                                </div>
                              </div>
                              <div className="col-lg-6 col-md-6">
                                <div className="billing-info">
                              ...
                              <div className="col-lg-12 col-md-12">
                                <div className="billing-info">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => setChangePasswordData({ ...changePasswordData, password2: e.target.value })}
                                  />
