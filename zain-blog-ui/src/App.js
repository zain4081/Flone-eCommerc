...
const PopularBlog = lazy(() => import("./pages/blog/PopularBlog"));
const TopBlog = lazy(() => import("./pages/blog/TopBlog"));
const FeaturedBlog = lazy(() => import("./pages/blog/FeaturedBlog"));
          ...
          >
            ...
            <Routes>
              ...
              <Route
                ...
                element={access_token ? <TopBlog/> : <Navigate to="/login-register"/>}
              />
              <Route
                path={process.env.PUBLIC_URL + "/featured_blog"}
                element={access_token ? <FeaturedBlog/> : <Navigate to="/login-register"/>}
              />
              <Route
                path={process.env.PUBLIC_URL + "/popular_blog"}
                element={access_token ? <PopularBlog/> : <Navigate to="/login-register"/>}
              />
              <Route
